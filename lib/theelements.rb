class Elements
  $periodic = {
    ...
    "Np" => { name: "Neptunium", atomic_number: 93 },
    "Pu" => { name: "Plutonium", atomic_number: 94 },
    "Am" => { name: "Americium", atomic_number: 95 },
    "Cm" => { name: "Curium", atomic_number: 96 },
    "Bk" => { name: "Berkelium", atomic_number: 97 },
    "Cf" => { name: "Californium", atomic_number: 98 },
    "Es" => { name: "Einsteinium", atomic_number: 99 },
    "Fm" => { name: "Fermium", atomic_number: 100 },
    "Md" => { name: "Mendelevium", atomic_number: 101 },
    "No" => { name: "Nobelium", atomic_number: 102 },
    "Lr" => { name: "Lawrencium", atomic_number: 103 },
    "Rf" => { name: "Rutherfordium", atomic_number: 104 },
    "Db" => { name: "Dubnium", atomic_number: 105 },
    "Sg" => { name: "Seaborgium", atomic_number: 106 },
    "Bh" => { name: "Bohrium", atomic_number: 107 },
    "Hs" => { name: "Hassium", atomic_number: 108 },
    "Mt" => { name: "Meitnerium", atomic_number: 109 },
    "Ds" => { name: "Darmstadtium", atomic_number: 110 },
    "Rg" => { name: "Roentgenium", atomic_number: 111 },
    "Cn" => { name: "Copernicium", atomic_number: 112 },
    "Nh" => { name: "Nihonium", atomic_number: 113 },
    "Fl" => { name: "Flerovium", atomic_number: 114 },
    "Mc" => { name: "Moscovium", atomic_number: 115 },
    "Lv" => { name: "Livermorium", atomic_number: 116 },
    "Ts" => { name: "Tennessine", atomic_number: 117 },
    "Og" => { name: "Oganesson", atomic_number: 118 }
}
module Cmd
	def self.show()
elements_table = [
...
def self.search(text)
  el = $periodic
  el.each { |key,value| puts("\nSymbol: #{key}\nname: #{value[:name]}\nnumber: #{value[:atomic_number]}") if key == text[0] }
  return nil
end 
end
def list
